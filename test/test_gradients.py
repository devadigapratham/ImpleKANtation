...
class TestGradients(unittest.TestCase):
    ...
    def test_gradients_MLP_KAN(self):
        # Validate gradient of loss with respect to weights via finite differences
        h = 1e-7
    ...
    def test_gradients_MLP_NN(self):
        ...
        for aa in [relu, tanh_act, sigmoid_act]:
            mlp = FeedForward([1, 4, 3, 1], eps=0.0001, activation=aa)
            x_train = [[np.random.rand()]]
